...
const Card = ( { item, bucket, id, editCard } ) => (
    ...
    >
        ...
        <div className="card__controls" style={{ 'border-top': '2px #dddddd solid', 'padding-top': '5px', 'text-align': 'right', 'margin-bottom': '-15px', 'margin-left': '-16px', 'margin-right': '-16px', 'padding-left': '10px', 'padding-right': '10px', 'padding-bottom': '5px', 'background': '#e0e0e0', 'position': 'relative', 'top': '2px' }}>
